...
start  cmd /k "echo Listener && cd Backend/Listener_Module && python fastAPI.py"
start  cmd /k "echo MS Gerenciador de Emails && cd Backend/MS_Email_Module && npm run dev"
start  cmd /k "echo Frontend React && cd Frontend/React_frontend/ && npm run dev"
start  cmd /k "echo Prisma Studio && cd Backend/API_User_Module && npx prisma studio"