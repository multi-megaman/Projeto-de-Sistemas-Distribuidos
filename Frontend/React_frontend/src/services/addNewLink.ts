...
export async function addNewLink(link: string){
    const response: any = await axios.post(`${userApiUrl}/user/addNewLink`,{url: link},{headers: {"x-access-token": Cookies.get("token")}}
    );
